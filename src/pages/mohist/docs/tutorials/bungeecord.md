...
```
如果您正在尝试设置代理 在本地网络中，您还需要将 "服务器端口" 值 __server.properties__ -> 设置 "服务器端口=25566" 例如 
(如果您有多个服务器, *如果您正在运行代理，您应该拥有多个服务器*, 不要在此处为每个服务器设置相同的端口.)
...
* 现在，您需要更改 __config.yml__ 在 Waterfall 文件夹内:
